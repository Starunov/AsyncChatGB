...
class ClientDatabase:
    ...
    def __init__(self, name):
        ...
        # Создаём отображения
        self.registry_mapper.map_imperatively(self.KnownUsers, users)
        self.registry_mapper.map_imperatively(self.MessageHistory, history)
        self.registry_mapper.map_imperatively(self.Contacts, contacts)
    ...
    # Функция возвращающая наличие пользователя в известных
